...
// Discord Guild ID (enable the Discord "Server Widget" in your server settings).
// This value is used as the "email system" count on the left side of the loading screen.
var DISCORD_GUILD_ID = ""; // e.g. "123456789012345678"

// FiveM server HTTP endpoint (for players.json & info.json).
// This value is used as the "people in the state" count.
var FIVEM_SERVER_ENDPOINT = "http://SERVER.IP.HERE:30120";
